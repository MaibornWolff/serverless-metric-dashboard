...
describe('timeUtils', function () {
    ...
    describe('#getStartEndDiffDecimal() with startTime', function () {
        it('should return a value > 0', function () {
            timeUtils.setStartTime(testTime);
            assert(timeUtils.getStartEndDiffDecimal() > 0);
        });
    });
    timeUtils = require('../src/util/timeUtils');
    describe('#getStartEndDiffDecimal(startTime) without setStartTime', function () {
        it('should return a value > 0', function () {
            assert(timeUtils.getStartEndDiffDecimal(testTime) > 0);
        });
    });
    timeUtils = require('../src/util/timeUtils');
